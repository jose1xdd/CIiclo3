...
from medicli.models import Familiar, familiar
from medicli.serializers.familiarSerializer import FamiliarSerializer
...
class FamiliarDetail(APIView):
    ...
    def get_object(self, pk):
        try:
            return Familiar.objects.get(cedula=pk)
